...
## Summary
R325健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定29轮，代码级差距0。WeShop无新增重大变化，模型矩阵维持(Grok12/Seedance10/Kling10/z-image8/Seedream7/Wan6/Sora6/GPT5/Veo4/Midjourney4/Hailuo4/FireRed4)，所有剩余差距均为用户提供决策级别(A/B/C级)。

## output
```json
{
  "success": true,
  "summary": "R325健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定29轮，代码级差距0。",
  "output": {
    "修复内容": "无 — 全量通过",
