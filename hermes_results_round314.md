...
## WeShop Comparison Analysis (R314)

### WeShop AI 当前状态
- **Social Proof**: 3,000,000 users
- **AI Image模型**: Nano Banana2, Seedream 5.0, Qwen Image Edit, Midjourney, Z-Image, Nano Banana Pro, FireRed, Grok Imagine
- **AI Video模型**: Kling 3.0, Sora 2, Wan AI Video, Seedance 2.0, Grok Imagine AI Video
- **语言**: 9种 (en-US, zh-CN, pt, es, ru, fr, de, id, ko)
- **App推广**: iOS/Android App下载入口
- **Resource中心**: Blog/FAQ/Feature Request
- **Solutions页面**: 6类用户场景 (商户/全球品牌/摄影师/营销团队/电商运营/第三方服务商)
...
## Summary
R314健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定14轮，代码级差距0。WeShop无新增重大变化，所有剩余差距均为用户提供决策级别(A/B/C级)。

## output
```json
{
  "success": true,
  "summary": "R314健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定14轮，代码级差距0。WeShop无新增重大变化，所有剩余差距均为用户提供决策级别。",
  "output": {
    "修复内容": "无 — 全量通过",
