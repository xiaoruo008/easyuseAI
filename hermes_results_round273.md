...
## Summary
R273健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定4轮。WeShop模型矩阵无变化。代码级差距0。

## output
```json
{
  "success": true,
  "summary": "R273健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定4轮。WeShop模型矩阵无变化。代码级差距0。",
  "output": {
