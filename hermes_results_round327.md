...
## Summary
R327健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定31轮，代码级差距0。WeShop对比无新增变化，所有剩余差距均为用户提供决策级别(A/B/C级)。
...
- **Real case results**: 4 image cards (CaseWall修复后)
...
{
  "success": true,
  "summary": "R327健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定31轮，代码级差距0。WeShop对比无变化，所有剩余差距均为用户提供决策级别(A/B/C级)。",
  "output": {
    "修复内容": "无 — 全量通过",
