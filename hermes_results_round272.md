...
**WeShop模型提及次数（与R270/R271完全一致，无变化）：**
...
## Summary
R272健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定2轮。WeShop模型矩阵无变化。代码级差距0。

## output
```json
{
  "success": true,
  "summary": "R272健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定2轮。WeShop模型矩阵无变化。代码级差距0。",
  "output": {
