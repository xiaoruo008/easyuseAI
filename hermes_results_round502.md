...
| Port | Status | Note |
|------|--------|------|
| 3005 | ✅ 200 | Dev server healthy |
| 3000 | ❌ 000 | Dead / orphan next-server not running |
...
{
  "success": true,
  "summary": "R502健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定49轮，代码级差距0。port 3000已死，仅3005存活。WeShop对标无变化，所有剩余差距均为用户提供决策级别(A/B/C级)。",
  "output": {
    "修复内容": "无 — 所有检查自动通过",
