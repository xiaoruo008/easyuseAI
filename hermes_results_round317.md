...
## Summary
R317健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定20轮，代码级差距0。WeShop无新增重大变化，所有剩余差距均为用户提供决策级别(A/B/C级)。

## output
```json
{
  "success": true,
  "summary": "R317健康检查全量通过(HTTP200/Console0/Flow5/5/Mobile3/3)。连续稳定20轮，代码级差距0。WeShop无新增重大变化，所有剩余差距均为用户提供决策级别。",
  "output": {
    "修复内容": "无 — 全量通过",
